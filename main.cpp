...
// Uso la Lista que dieron en clase, no la nuestra que utilizamos en el tp2
...
// Adaptar la clase Vértice, Grafo y Prim, teniendo en cuenta que los datos seran del tipo Lectura*
